...
async function scrapeProduct(browser, url, pagenum) {
  ...
  /*
    ...
    */
    scrapeProduct(browser, 'https://www.daraz.com.bd/womens-clothing/', pagenum+1);
...
setTimeout(async ()=>{
    ...
    await scrapeProduct(browser, 'https://www.daraz.com.bd/womens-clothing/', 1);
})